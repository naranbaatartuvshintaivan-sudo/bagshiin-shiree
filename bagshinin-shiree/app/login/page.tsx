    ...
    <div className="flex min-h-screen items-center justify-center bg-paper px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <form
          ...
          className="rounded-2xl border border-primary-soft/50 bg-white p-6 space-y-4 shadow-sm"
        >
          <div className="space-y-1.5">
            ...
            <input
              ...
              required
              className="w-full rounded-xl border border-primary-soft/60 bg-paper px-3 py-2 text-sm text-ink placeholder:text-ink/40 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full rounded-xl border border-primary-soft/60 bg-paper px-3 py-2 pr-10 text-sm text-ink placeholder:text-ink/40 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
              />
              <button
                type="button"
